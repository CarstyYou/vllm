#!/bin/bash
# task_10 r2/r3 supplement sweep: both backends x all cc, warmup2 + r2 + r3.
...
for BK in cute_sm120_mxfp8_32 deep_gemm_mxfp8_32; do
  ...
  enroot start --rw \
    ...
    fi-ci-cu130 bash -c "export CUDA_VISIBLE_DEVICES=$UUID; bash /workspace/bench_5kp_r23.sh $BK \"$CC\" \"warmup2 r2 r3\""
  brc=$?
